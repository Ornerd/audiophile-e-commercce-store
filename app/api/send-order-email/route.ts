  ...
  <body>
    ...
    <div class="content">
      ...
      <div style="text-align: center; margin: 30px 0;">
        ...
        <a href="https://audiophile-e-commercce-store-orb.vercel.app/confirmation?orderNumber=${body.orderNumber}" class="cta-button">
          View Your Order
        </a>
        <p style="font-size: 14px; color: #666; margin-top: 10px;">
          Or copy this link:https://audiophile-e-commercce-store-orb.vercel.app/confirmation?orderNumber=${body.orderNumber}
        </p>
      </div>
    </div>
