const ButtonThree = ({onClick}: {onClick:() => void}) => {

    let butttonThreeCTA = 'shop'

  return (
    <button onClick={onClick} className="w-fit uppercase flex items-center justify-center gap-[13.3px] text-[0.8125rem] cursor-pointer">
